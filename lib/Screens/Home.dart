        ...
        child: Column(children: <Widget>[
          Padding(
            ...
            child: Row(children: <Widget>[
              ...
              InkWell( onTap: (){ Navigator.push(context, MaterialPageRoute(builder: (context) => Deals())); },
                child: Container(
                  height: 30, width: 80,
          ...
          child: ListView.builder(scrollDirection: Axis.horizontal,
            ...
            itemBuilder: (context, index){
              return InkWell(
                  ...
                  child: _buildItem('assets/tv1.PNG', 'SAMSUNG', '43-Inch Series 7 4K UHD Smart TV Black', 'EGP 8,910.00'));
            },),
        ),
        _top('Make Up'),
        SizedBox(width: MediaQuery.of(context).size.width, height: 400,
